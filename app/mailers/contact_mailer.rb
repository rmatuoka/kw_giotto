class ContactMailer < ActionMailer::Base
  ...
  def send_representative_to_adm(contact)
    @contact = contact
    mail(:to => "comercial@produtosgiotto.com.br",:bcc => "log@korewa.com.br", :subject => "Giotto - Novo Contato")
  end
  ...
  def send_work_to_adm(contact)
    @contact = contact
    mail(:to => "vagner@produtosgiotto.com.br",:bcc => "bsouza@korewa.com.br", :subject => "Giotto - Novo CV")
  end
end
